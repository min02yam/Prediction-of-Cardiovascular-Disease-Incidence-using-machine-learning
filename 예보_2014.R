...
#최종병합
final_list=list(강원_2014, 경기_2014, 경남_2014, 경북_2014,광주_2014,
                대구_2014, 대전_2014, 부산_2014, 서울_2014, 세종_2014,
                울산_2014, 인천_2014, 전남_2014, 전북_2014, 제주_2014,
                충남_2014, 충북_2014)
f2014=join_all(final_list, by="date", type="left") 

#저장
setwd("C:/Users/alsdu/Downloads/예보데이터/예보데이터/2014")
write.csv(f2014,"f2014.csv", row.names = FALSE)
